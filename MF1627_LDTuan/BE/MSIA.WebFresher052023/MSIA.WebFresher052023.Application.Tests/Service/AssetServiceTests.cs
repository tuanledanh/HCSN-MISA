...
namespace MSIA.WebFresher052023.Application.Tests.Service
{
    ...
    public class AssetServiceTests
    {
        ...
        public IFixedAssetCategoryRepository assetTypeRepository { get; set; }
        ...
        public void SetUp()
        {
            ...
            assetTypeRepository = Substitute.For<IFixedAssetCategoryRepository>();
            mapper = Substitute.For<IMapper>();
            assetManager = Substitute.For<IFixedAssetManager>();
            unitOfWork = Substitute.For<IUnitOfWork>();
            assetService = new FixedAssetService(assetRepository, mapper, departmentRepository, assetTypeRepository, assetManager, unitOfWork);
        }
        #endregion
